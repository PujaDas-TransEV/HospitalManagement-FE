...
const DoctorLeave = () => {
  ...
  useEffect(() => {
    const fetchDoctorLeave = async () => {
      ...
      try {
        ...
        const response = await fetch("http://192.168.0.106:5000/doctors/getallleavebydocid", {
          method: "POST",
  ...
  const handleUpdateLeave = async (e) => {
    ...
    try {
      const response = await fetch("http://192.168.0.106:5000/doctors/leaveupdate", {
        method: "POST",
        headers: { Authorization: `Bearer ${accessToken}` },
        body: formData,
      });
  ...
  const handleApplyLeave = async (e) => {
    ...
    try {
      const response = await fetch("http://192.168.0.106:5000/doctors/create/leave", {
        method: "POST",
        headers: { Authorization: `Bearer ${accessToken}` },
        body: formData,
      });
  ...
  const handleDelete = async (leaveId) => {
    ...
    try {
      const response = await fetch("http://192.168.0.106:5000/doctorsops/deleteleave", {
        method: "POST",
        headers: { Authorization: `Bearer ${accessToken}` },
        body: formData,
      });
