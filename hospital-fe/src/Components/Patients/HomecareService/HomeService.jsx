...
// import Modal from 'react-modal';
// import { useNavigate } from 'react-router-dom';
// import { FaEye, FaTimesCircle, FaSave, FaBan, FaTrash, FaSpinner } from 'react-icons/fa';
// import './HomeService.css';
// import PatientNavbar from '../Navbar/PatientNavbar';
// import PatientSidebar from '../Sidebar/PatientSidebar';
...
//         formData
//       );
//       // Set requests without caring about attachments
//       setRequests(res.data.data || []);
//       setError(null);
//     } catch (e) {
//       setError('Failed to fetch home care requests.');
...
//         setRequests((prev) => prev.filter((req) => req.homecare.uid !== uid));
//         if (selectedRequest?.homecare?.uid === uid) {
//           setSelectedRequest(null);
//         }
//         setPopupMessage('Homecare deleted successfully.');
...
//                 {/* Editable fields (excluding attachments) */}
//                 {Object.keys(selectedRequest.homecare).map((key) => {
//                   if (key === 'attachments') return null; // Skip attachments completely
...
//                 <div className="modal-footer-homecare">
//                   {selectedRequest.homecare.status !== 'cancelled' &&
//                     canCancel(selectedRequest.homecare.timefrom) && (
//                       <button
...
//           {popupMessage && (
//             <div className="popup-message-homecare">{popupMessage}</div>
//           )}
//         </div>
//       </div>
//     </div>
