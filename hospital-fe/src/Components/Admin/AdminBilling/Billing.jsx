...
import { FaSearch, FaEye, FaPlus, FaEdit, FaTimes,FaSpinner,FaRedo } from 'react-icons/fa';
...
const AdminBillingPage = () => {
  ...
  return (
    <div className="dashboard-container billing-background">
      <AdminNavbar />
                ...
                {bills.map((bill) => (
                  <tr key={bill.billid}>
                    ...
                    <td className="action-buttons">
                      <button onClick={() => handleView(bill.billid)} className="btn-view">
                        <FaEye /> View
                      </button>

                      <button onClick={() => openEditPopup(bill.billid)} className="btn-edit">
                        <FaEdit /> Edit
                      </button>
                    </td>
                  </tr>
