...
const FacilityManagementPage = () => {
 ...
 const [showDetailsModal, setShowDetailsModal] = useState(false);
  ...
  const handleEditFacility = (e) => {
    ...
    fetch('http://localhost:5000/facilityops/updatefacilitydata', {
      method: 'POST',
      body: formDataObj,
    })
      .then((response) => response.json())
  ...
  const handleDeleteFacility = (facilityId) => {
    ...
    fetch('http://localhost:5000/facilityops/deletefacility', {
      method: 'POST',
      body: formDataObj,
    })
      .then((response) => response.json())
...
const handleViewDetails = (facilityId) => {
  ...
  const handleAddFacility = (e) => {
    ...
    fetch('http://localhost:5000/facilityopscreate', {
      method: 'POST',
      body: formDataObj,
    })
      .then((response) => response.json())
